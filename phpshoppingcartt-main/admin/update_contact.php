...
?>
    <main id="main-container">
        <div class="content">
            <h2 class="content-heading" style="margin-top: -10px">Editar Contacto</h2>
                        ...
                        <form class="col-md-8" name="form1" action="" method="post" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="inputdescription" class="col-form-label">Descripción del contacto</label>
                                    <textarea class="form-control" name="description"
                                              id="elm1"><?php echo $contact; ?></textarea>

                                </div>

                                <div class="form-group col-md-12">
                                    <button type="submit" class="btn btn-primary default-btn-color" name="submit1"
                                            id="submit">Actualizar Contacto
                                    </button>
                                </div>
                                <div class="alert alert-success col-md-12" id="d11" style="display: none;">
                                    <strong>Éxito!</strong> Actualización de contacto realizada con éxito.
                                </div>
                        </form>
...
if (isset($_POST["submit1"])) {
        ...
        mysqli_query($link, "update about_contact_title set contact='$_POST[description]'")  or die(mysqli_error($link));
